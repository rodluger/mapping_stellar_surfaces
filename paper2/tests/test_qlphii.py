...
def qli_numerical_x(l, i, alpha, beta):
    """Integration of the reparametrized q^l_i by quadrature."""
...
def test_qli(lmax=10, alpha=3.0, beta=5.0):
    """
    Show that both our reparametrization and the closed form expression
    for the integral is correct.
