...
While there have been several recent papers


\xxx{...}
the exponential sine squared kernel \citep[Equation~\ref{eq:expsinsq}][]{Wang2012},
quasi-periodic kernel \citep{Angus2018},
or the \celerite \textsf{RotationTerm} \citep{ForemanMackey2017}.
quasi-periodic cosine kernel\citep[e.g.,][]{Perger2020}
\xxx{...}
...
since we must be careful to distinguish between the
...
\xxx{Similar to \citet{Morris2020}}.
...
in \S\ref{sec:baseline}, the fractional
