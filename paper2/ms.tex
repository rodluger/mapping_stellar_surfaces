...
and stellar contributions \xxx{\citep{XXX}}, these models can struggle
when the (a priori unknown) orbital period of the planet
is close to an alias of the rotational period of the star \xxx{\citep{XXX}}.
...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{brightspots}{%
            ...
            the baseline (\S\ref{sec:gp-norm}), it is very
...
However, as we argue in \S\ref{sec:gp-norm}, the mean is not a direct
