...
\begin{abstract}
    \xxx{TODO: This paper is the first in a series on stellar mapping.
        We talk about the degeneracies in the light curve ``inversion'' problem
        and show how any result based on just one stellar light curve is necessarily
        extremely prior-dominated. We show how these degeneracies can be broken with
        ensemble analyses. We also discuss the baseline degeneracy, which isn't
        always appreciated but has profound implications for what we can and cannot
        know about a stellar surface.}
\end{abstract}
...
\xxx{Outline of paper here. TODO: Cite Emily Rauscher's papers on eigen light curves.}
