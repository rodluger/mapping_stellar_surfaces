...
\xxx{A little linear algebra here:}
...
\end{align}
%
where $\mathbf{U}$ and $\mathbf{V}$ are
$(K \times N)$ orthogonal matrices
and $\mathbf{S}$ is a $(N \times N)$ diagonal matrix
containing the $R$ nonzero singular values as well as
$N - R$ zeros.
%
Write
%
...
\end{align}
%
Note that because $\mathbf{V}$ is orthogonal,
%
\begin{align}
...
\begin{align}
    ...
    \\
               & =
    \mathbf{U}_\bullet \mathbf{S} \mathbf{V}_\bullet^\top \mathbf{y}
    +
    \mathbf{U}_\circ \mathbf{0} \mathbf{V}_\circ^\top \mathbf{y}
    \\
               & =
    \mathbf{U}_\bullet \mathbf{S} (\mathbf{V}_\bullet^\top \mathbf{V}_\bullet) \mathbf{V}_\bullet^\top \mathbf{y}
    +
    \mathbf{U}_\circ \mathbf{0} (\mathbf{V}_\circ^\top \mathbf{V}_\circ) \mathbf{V}_\circ^\top \mathbf{y}
    \\
               & =
    (\mathbf{U}_\bullet \mathbf{S} \mathbf{V}_\bullet^\top) \mathbf{V}_\bullet \mathbf{V}_\bullet^\top \mathbf{y}
    +
...
\end{align}
%
are the row space and null space components of $\mathbf{y}$.
